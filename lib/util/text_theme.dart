...
class TtextTheme {
  static TextTheme lightTextTheme = TextTheme(
    displayLarge: const TextStyle().copyWith(fontSize: 48, fontWeight: FontWeight.w700,color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    displayLarge: const TextStyle().copyWith(fontSize: 48, fontWeight: FontWeight.w700,color: Colors.white),
